...
from server_manager.src.paths import gen_and_save_server_path, get_server_path
...
class TestGetServerPath:
    ...
    def mocks(self):
        ...
        self.gassp_m = mock.patch(root + "gen_and_save_server_path").start()
    ...
    def test_file_exists(self):
        ...
        self.gassp_m.assert_not_called()
    ...
    def test_file_not_exist(self):
        ...
        result = get_server_path()
        assert result == self.gassp_m.return_value
        ...
        self.input_m.assert_not_called()
        self.gassp_m.assert_called_once_with()
        self.data_path_m.write_text.assert_not_called()


class TestGenAndSaveServerPath:
    @pytest.fixture(autouse=True)
    def mocks(self):
        root = "server_manager.src.paths."
    ...
    def test_file_not_exist(self):
        ...
        result = gen_and_save_server_path()
        assert result == Path("<root-path>")

        self.data_path_m.is_file.assert_not_called()
        self.data_path_m.read_text.assert_not_called()
